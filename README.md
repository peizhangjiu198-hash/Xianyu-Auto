...
基于商品详情和完整聊天记录，AI 智能分析并生成精准回复。

![AI 智能回复配置](Picture/AI%20Setup.png)

**核心能力：**
- 🧠 **深度理解商品详情**：AI 自动分析商品标题、价格、描述、图片等信息，精准把握商品特点
- 💬 **参考全部聊天记录**：AI 会学习买家与卖家的完整对话历史，了解上下文，回复更连贯自然
- 🎯 **智能上下文理解**：根据买家提问意图、历史沟通内容，生成针对性回复
- 🧠 **多模型支持**：智谱 AI、OpenAI、通义千问等，可接入本地部署的 Ollama、vLLM、LM Studio
- ✏️ **自定义提示词**：灵活控制 AI 回复风格，打造专属客服形象
- 🧪 **在线测试**：支持 API 连接测试，确保稳定可用
- 📏 **智能长度控制**：自动生成简洁专业的回复（默认不超过 50 字，可自行调整）

**工作原理：**
```
买家消息 → AI根据提示词 →AI 分析商品详情 → AI 参考全部聊天记录 → 生成精准回复
```

**示例场景：**
```
商品：二手 iPhone 13 128G 黑色
买家："电池怎么样？"
AI 会参考：
  ✅ 商品详情（电池健康度 92%）
  ✅ 历史聊天记录（之前已讨论过配件、成色）
  ✅ 生成回复："电池健康度 92%，正常使用完全没问题，之前跟您说的配件也都齐全哦~"
```
